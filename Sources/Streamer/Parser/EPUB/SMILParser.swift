...
final class SMILParser {
    ...
    internal static func parseSequences(in element: Fuzi.XMLElement, withParent parent: MediaOverlayNode, publicationReadingOrder readingOrder: inout [Link], base: String) {
...
//            link.properties.mediaOverlay = EPUBConstant.mediaOverlayURL + link.href
    ...
    ///   - parent: The parent MediaOverlayNode of the "to be creatred" nodes.
    internal static func parseParameters(in element: Fuzi.XMLElement, withParent parent: MediaOverlayNode, base: String) {
