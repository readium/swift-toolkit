...
/// schemes.
public final class DefaultResourceFactory: CompositeResourceFactory, @unchecked Sendable {
    /// - Parameters:
...
public class CompositeResourceFactory: ResourceFactory, @unchecked Sendable {
