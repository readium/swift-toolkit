...
public protocol HTMLFontFamilyDeclaration {
    ...
    func inject(in html: String, servingFile: (URL) throws -> AbsoluteURL) throws -> String
}
...
public struct AnyHTMLFontFamilyDeclaration: HTMLFontFamilyDeclaration {
    ...
    private let _inject: (String, (URL) throws -> AbsoluteURL) throws -> String
    ...
    public func inject(in html: String, servingFile: (URL) throws -> AbsoluteURL) throws -> String {
...
public struct CSSFontFace {
    ...
    func injections(for html: String, servingFile: (URL) throws -> AbsoluteURL) throws -> [HTMLInjection] {
        try sources
            .filter(\.preload)
            .map { source in
    ...
    func css(for fontFamily: String, servingFile: (URL) throws -> AbsoluteURL) throws -> String {
