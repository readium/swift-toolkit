...
@Suite struct KeychainTests {
    ...
    @Test func saveMultipleKeys() throws {
        ...
        #expecttry (keychain.load(forKey: "key1") == data1)
        #expecttry (keychain.load(forKey: "key2") == data2)
        #expecttry (keychain.load(forKey: "key3") == data3)
    }
    ...
    @Test func deleteAll() throws {
        ...
        #expecttry (keychain.load(forKey: "key1") == nil)
        #expecttry (keychain.load(forKey: "key2") == nil)
        #expecttry (keychain.load(forKey: "key3") == nil)
    }
    ...
    @Test func serviceIsolation() throws {
        ...
        #expecttry (keychain2.load(forKey: "shared-key") == nil)
    }
}
