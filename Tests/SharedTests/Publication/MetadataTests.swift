...
class MetadataTests: XCTestCase {
    ...
    let fullMetadata = Metadata(
        ...
        accessibility: Accessibility(conformsTo: ["profile"]),
    ...
    func testParseFullJSON() {
        XCTAssertEqual(
            try Metadata(json: [
                ...
                "title": ["en": "Title", "fr": "Titre"],
                "subtitle": ["en": "Subtitle", "fr": "Sous-titre"],
                "accessibility": ["conformsTo": "profile"],
    ...
    func testCopy() {
        ...
        let copy = metadata.copy(
            ...
            accessibility: Accessibility(conformsTo: ["copy-profile"]),
        ...
        AssertJSONEqual(
            ...
            [
                ...
                "title": "copy-title",
                "subtitle": "copy-subtitle",
                "accessibility": ["conformsTo": ["copy-profile"]],
