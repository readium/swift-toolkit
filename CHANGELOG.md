...
* [#121](https://github.com/readium/swift-toolkit/issues/121) HTML `<audio>` and `<video>` elements are now paused when turning the page in the EPUB navigator, instead of playing on in the background.
